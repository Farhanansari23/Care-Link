...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _body(context) {
    return Consumer<AuthenticationProvider>(builder: (context, authProvider, _) {
      return Form(
        key: _formState,
        child: Container(
                    ...
                    CustomElevatedButton(
                      ...
                      onPressed: () {
                        if(_formState.currentState!.validate()){
                          setState(() {
                            email = authProvider.userEmailTextEditingController.value.text;
                            password = authProvider.userPasswordTextEditingController.value.text;
                          });
                          userLogin();
                        }
                      },
